<a
	href="/create"
	class="flex flex-row items-center justify-center gap-1 max-w-max bg-primary-700 text-surface-50 px-4 py-2 rounded outline-none transition hover:text-white hover:bg-primary-600"
>
	<svg
		class="w-5 h-5"
